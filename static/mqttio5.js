...
function onMessageArrived(msg) { // 매개변수 msg는 도착한 MQTT 메시지를 담고 있는 객체
    ...
    if (msg.destinationName == "deskcheck"){
        document.getElementById("messages_1").innerHTML += msg.payloadString;
    }
    ...
    addChartData(parseFloat(msg.payloadString)); // 메시지에 담긴 파일 이름으로 drawImage() 호출. drawImage()는 웹 페이지에 있음
}
